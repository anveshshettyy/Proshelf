...
export default function CreateCollectionDrawer({ onClose, onSubmit, title, setTitle, description, setDescription }) {
  return (
    <div className="w-full bg-slate-200 rounded-2xl mt-5 px-5 py-6  shadow-xl animate-slideDown">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-head">Create New Collection</h2>
        <button
          onClick={onClose}
