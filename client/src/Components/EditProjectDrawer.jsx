...
export default function EditProjectDrawer({ onClose, onSubmit, title, setTitle, description, setDescription }) {
  return (
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            rows={3}
            className="p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-black font-med"
            placeholder="e.g. Updated layout and animations for personal portfolio"
          />
        </div>
